...
fluidPage(
  ...
  sidebarLayout(
    sidebarPanel( 
      fluidRow(
        column(3, sliderInput("a1",
                              "a1:",
                              min = -5,
                              max = 5,
                              value = 0)),
        column(3, sliderInput("a2",
                              "a2:",
                              min = -5,
                              max = 5,
                              value = 0)),
        column(3, sliderInput("b1",
                              "b1:",
                              min = -5,
                              max = 5,
                              value = 1)),
        column(3, sliderInput("b2",
                              "b2:",
                              min = -5,
                              max = 5,
                              value = 1))
      ...
      fluidRow(
        column(3, sliderInput("mu1",
                              "mu1:",
                              min = -5,
                              max = 5,
                              value = 0)),
        column(3, sliderInput("mu2",
                              "mu2:",
                              min = -5,
                              max = 5,
                              value = 0)),
        column(3, sliderInput("sd1",
                              "sd1:",
                              min = 0,
                              max = 5,
                              value = 1)),
        column(3, sliderInput("sd2",
                              "sd2:",
                              min = 0,
                              max = 5,
                              value = 1))
