...
Likelydata <-
function(dataset = temp, a1 = 1, a2 = 2, b1 = 1, b2 = 2, a1a2b1b2){
  if(!missing(a1a2b1b2)){
  ...
  phij1 = inverselogit(a1 + b1 * dataset$x1)
  phij2 = inverselogit(a2 + b2 * dataset$x2)
  phij1phij2 = cbind(phij1, phij2)
  minphij = apply(X = phij1phij2, MARGIN = 1, FUN = min)
  return(sum(dataset$y*log(minphij) + (1 - dataset$y) * log(1 - minphij)))
