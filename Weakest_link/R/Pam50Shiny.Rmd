...
Choose your dataset between METABRIC and Simulated data.  If simulated data is chosen, you can adjust the population size, as well as the a's and b's.   If METABRIC data is chosen, choose a pair of PAM50 genes for the predictors.
...
output$fittedSimulated = renderPlot({
    print(input$sim_population)
    print(input$a1_adjust)
    try({
